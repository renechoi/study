...
function stringAndNumber() {
    console.log((0, _lodashDefault.default).upperCase("hello"));
    const String1 = "Hello";
    const String2 = "hello";
    const String3 = `hello`;
...
function optionalChaining() {
    ...
    function getCity(user1) {
        return user1.address?.city || "주소 없음.";
    }
...
function forIteration() {
    ...
    for (user of users)console.log(user.name);
...
function functionPractice() {
    ...
    const getRootUser = (user1)=>{
        if (user1.parent) return getRootUser(user1.parent);
        return user1;
    };
    setTimeout(()=>{
        console.log("hello");
...
function classPractice() {
    ...
    class User2 {
        ...
        static isUser(user1) {
            if (user1.firstName && user1.lastName) return true;
            return false;
        }
    }
    class Vehicle {
...
function arrayPractice() {
    ...
    const newUsers = users.map((user1)=>{
        return {
            ...user1,
            isValid: true,
            email: null
