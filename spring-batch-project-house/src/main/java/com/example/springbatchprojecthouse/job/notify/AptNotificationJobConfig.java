...
import com.example.springbatchprojecthouse.core.dto.NotificationDto;
...
import com.example.springbatchprojecthouse.job.validator.DealDateParameterValidator;
...
public class AptNotificationJobConfig {
    ...
    public ItemProcessor<AptNotification, NotificationDto> aptNotificationProcessor(
        ...
        return aptNotification -> {
            ...
            /**
             * null 리턴시 종단되어 writer로 넘어가지 않는다.
             */
